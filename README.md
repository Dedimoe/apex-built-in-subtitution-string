...
3.9.4.39.1 About Scope and Value of REQUEST for Posted Pages
...
3.9.4.39.2 About the When Button Pressed Attribute
...
3.9.4.39.3 About Referencing REQUEST Using Declarative Conditions
...
3.9.4.39.4 About Using REQUEST for Show Processing
...
3.9.4.39.5 About Using BRANCH_TO_PAGE_ACCEPT
